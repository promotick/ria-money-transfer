    ...
    function init_popup_beyond(){
      if($(window).width() + boutique_get_scrollbar_width() >= 768){
          if($('body').hasClass('home-beyond')){
              ...
              $.magnificPopup.open({
                items: {
                  src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><img src="../images/welcome2.png"/></div></div></div>',  //can be a HTML string, jQuery object, or CSS selector
                  type: 'inline'
                }
              });
          }
